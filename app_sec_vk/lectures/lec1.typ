...
+ Понимание принципов информационной безопасности, ролей в информационной безопасности
и структуре ИБ в компаниях
+ Базовое понимание принципов Application Security (AppSec), роли AppSec-инженера и процесса SSDLC
...
+ Знание об топ-10 уязвимостях OWASP и дополнительных возможных уязвимостях: о методологии их
поиска и эксплуатации
+ Знание об уязвимостях клиентской части Android-приложений, научиться их выявлять, предотвращать
и применять методы защиты на практике
+ Знание об основных уязвимостях мобильных приложений, методах их эксплуатации и защите, включая
перехват трафика, атаки через WebView, XSS, MITM, фишинг, SSL Pinning и безопасное проектирование
в рамках SSDLC
+ Знание об инфраструктурной безопасности, безопасности ОС Linux, типовых угрозах в инфраструктуре,
митигации и защите от них, а также сформировать знание о том, как работает IAC и как пишутся Ansibleплейбуки
+ Базовые знание о Docker и Kubernetes, типовых уязвимостях в этих технологиях, мерах защиты
и харденинг
